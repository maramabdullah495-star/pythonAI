...
def filesGet():
    ...
    r"C:\Users\MOE\Desktop\pythonAI\Agedetection\data\deploy_age.prototxt",
    r"C:\Users\MOE\Desktop\pythonAI\Agedetection\data\age_net.caffemodel"
)
...
def read_from_camera(age_net,gender_net):
    ...
    image= cv2.imread('images/girl.webp') # استدعاء الصورة
